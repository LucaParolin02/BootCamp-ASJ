...
//var mensaje = prompt("Ingrese su texto para saber cantidad de caract");
//console.log(mensaje.length);

//var edad = prompt ("Ingrese su edad");
//console.log(parseInt(edad)*365);

/* var num1;
var num2;
var resultado;
num1 = prompt ("asignale un numero a sumar a num1");
num2 = prompt("asignale un numero a sumar a num2");
...
/* var edad = prompt ("Ingrese su edad");
edad = parseInt(edad);
var edadMaxima = prompt ("Ingrese su edad maxima");
edadMaxima = parseInt(edadMaxima);
var snackFav = prompt ("Ingrese el nombre de su snack favorito");
var snackPorDia = prompt ("Ingrese la cantidad de snack que consume por dia");
